	...
	var Counter = function Counter() {
	  return (0, _cyclow.Block)({
	    on: {
	      ...
	      'dom.increment': function domIncrement() {
	        return function (counter) {
	          return counter + 1;
	        };
	      },
	      'dom.decrement': function domDecrement() {
	        return function (counter) {
	          return counter - 1;
	        };
	      }
	    ...
	    view: function view(counter) {
	      return { tag: 'div#app', content: [{ tag: 'div.counter', content: '' + counter }, { tag: 'div.buttons', content: [{ tag: 'button', on: { click: 'decrement' }, content: '-' }, { tag: 'button', on: { click: 'increment' }, content: '+' }] }] };
	    }
	  });
	};

	(0, _cyclow.run)(Counter, { target: 'app' });
